...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="en">
 <head>
  ...
  <script type="text/javascript">
   var WEInfoPage={PHPVersion:"phpOK",OEVersion:"1-57-9",PagePath:"oe-bkoffice-v1/add-new-content",Culture:"EN",LanguageCode:"EN",RelativePath:"../",RenderMode:"Export",PageAssociatePath:"oe-bkoffice-v1/add-new-content",EditorTexts:null}
  </script>
       ...
       <div class="OECT OECT_Content OECTAbs OEDynTag0">
        <div id="WEd7201620c6" class="BaseDiv RWidth OEWELabel OESK_WELabel_Default" style="z-index:19">
         <div class="OESZ OESZ_DivContent OESZG_WEd7201620c6">
          <span class="OESZ OESZ_Text OESZG_WEd7201620c6 ContentBox"> <span style="font-size:13px;"><b><span lang="EN-US" style="line-height:115%;">Note to webmaster</span></b><span lang="EN-US" style="line-height:115%;"> (delete after reading): it is<span style="color:rgb(192, 0, 0);"><b> strongly recommended to consult the Wiki</b></span> (double-click « Wiki Help» in the list of Packs to the right) , in particular the section describing this Pack.&nbsp;</span></span></span>
         </div>
        </div>
        <div id="WEc59057add0" class="BaseDiv RNone OEWELink OESK_WELink_Default" style="z-index:1">
         <div class="OESZ OESZ_DivContent OESZG_WEc59057add0">
          <a class="OESZ OESZ_Link OESZG_WEc59057add0 ContentBox OEDynTag0" data-cd="PageLink" href="<?php echo $oei['WEc59057add0..OEDynTag0.href'];?>">Go to Content Administration page<br /></a>
         </div>
        </div>
        ...
        <div id="WE0f3a7371e0" class="BaseDiv RNone OEWELabel OESK_WELabel_Default" style="z-index:4">
         <div class="OESZ OESZ_DivContent OESZG_WE0f3a7371e0">
          <span class="OESZ OESZ_Text OESZG_WE0f3a7371e0 ContentBox">Item name (new or existing)</span>
         </div>
        </div>
        ...
        <div id="WE1af0e811eb" class="BaseDiv RNone OEWELabel OESK_WELabel_Default" style="z-index:6">
         <div class="OESZ OESZ_DivContent OESZG_WE1af0e811eb">
          <span class="OESZ OESZ_Text OESZG_WE1af0e811eb ContentBox">Detail name</span>
         </div>
        </div>
        ...
        <div id="WEad9f940792" class="BaseDiv RNone OEWELabel OESK_WELabel_Default" style="z-index:8">
         <div class="OESZ OESZ_DivContent OESZG_WEad9f940792">
          <span class="OESZ OESZ_Text OESZG_WEad9f940792 ContentBox">Type of content</span>
         </div>
        </div>
        ...
        <div id="WEcde138e9e9" class="BaseDiv RNone OEWELabel OESK_WELabel_Default" style="z-index:11">
         <div class="OESZ OESZ_DivContent OESZG_WEcde138e9e9">
          <span class="OESZ OESZ_Text OESZG_WEcde138e9e9 ContentBox">Use current date+time as "official" date of the item</span>
         </div>
        </div>
        ...
        <div id="WE1fc942f1cc" class="BaseDiv RWidth OEWELabel OESK_WELabel_Default" style="z-index:13">
         <div class="OESZ OESZ_DivContent OESZG_WE1fc942f1cc">
          <span class="OESZ OESZ_Text OESZG_WE1fc942f1cc ContentBox OEDynTag0">(Optional) Sorting Value (relative importance or priority of the item) e.g. "10" or "-10"</span>
         </div>
        </div>
        ...
        <div id="WE906950728c" class="BaseDiv RWidth OEWELabel OESK_WELabel_Default" style="z-index:21">
         <div class="OESZ OESZ_DivContent OESZG_WE906950728c">
          <span class="OESZ OESZ_Text OESZG_WE906950728c ContentBox OEDynTag0">(Optional, Invisible) IDs of Categories in format ID1+ID2+..+IDn, e.g. 1 or 2+4. Applied to new Items only.</span>
         </div>
        </div>
        <div id="WE2d3482cdbc" class="BaseDiv RNone OEWELabel OESK_WELabel_Default" style="z-index:14">
         <div class="OESZ OESZ_DivContent OESZG_WE2d3482cdbc">
          <span class="OESZ OESZ_Text OESZG_WE2d3482cdbc ContentBox">(Optional) Detail's Content (HTML or simple text)</span>
         </div>
        </div>
        ...
        <div id="WE5c81b9693b" class="BaseDiv RNone OEWELabel OESK_WELabel_Default" style="z-index:16">
         <div class="OESZ OESZ_DivContent OESZG_WE5c81b9693b">
          <span class="OESZ OESZ_Text OESZG_WE5c81b9693b ContentBox OEDynTag0">For security reasons, enter the backoffice password:<br /></span>
         </div>
        </div>
        ...
        <div id="WE37f74c882b" class="BaseDiv RWidth OEWEButton OESK_WEButton_Default" style="z-index:18">
         <div class="OESZ OESZ_DivContent OESZG_WE37f74c882b">
          <button class="OESZ OESZ_Button OESZG_WE37f74c882b OEDynTag0" type="button" name="WE37f74c882b">Add to database</button>
         </div>
        </div>
       </div>
      </div>
