       ...
       <div class="OECT OECT_Content OECTAbs OEDynTag0">
        ...
        <div id="WE96d3f4cb62" class="BaseDiv RNone OEWELink OESK_WELink_Default" style="z-index:6">
         <div class="OESZ OESZ_DivContent OESZG_WE96d3f4cb62">
          <a class="OESZ OESZ_Link OESZG_WE96d3f4cb62 ContentBox OEDynTag0" data-cd="PageLink" href="<?php echo $oei['WE96d3f4cb62..OEDynTag0.href'];?>">I don't have an account yet</a>
         </div>
        </div>
        ...
        <div id="WE843bc90eab" class="BaseDiv RNone OEWELabel OESK_WELabel_Default" style="z-index:12">
         <div class="OESZ OESZ_DivContent OESZG_WE843bc90eab">
          <span class="OESZ OESZ_Text OESZG_WE843bc90eab ContentBox OEDynTag0" style="<?php echo $oei['WE843bc90eab..OEDynTag0.style'];?>">Remember me on this computer</span>
         </div>
        </div>
       </div>
      </div>
