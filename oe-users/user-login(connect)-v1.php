...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="fr">
 <head>
  ...
  <script type="text/javascript">
   var WEInfoPage={PHPVersion:"phpOK",OEVersion:"1-57-9",PagePath:"oe-users/user-login(connect)-v1",Culture:"DEFAULT",LanguageCode:"FR",RelativePath:"../",RenderMode:"Export",PageAssociatePath:"oe-users/user-login(connect)-v1",EditorTexts:null}
  </script>
       ...
       <div class="OECT OECT_Content OECTAbs OEDynTag0">
        ...
        <div id="WE50d6dcb68e" class="BaseDiv RWidth OEWELabel OESK_WELabel_Default OECenterAH" style="z-index:13">
         <div class="OESZ OESZ_DivContent OESZG_WE50d6dcb68e">
          <span class="OESZ OESZ_Text OESZG_WE50d6dcb68e ContentBox"> <b><span style="line-height:115%;font-size:13px;">INFO POUR LES CREATEURS DU SITE - supprimer ce cadre après la lecture</span></b> <br /> Ce paquet n'est pas pour la page d'accueil (index.htm/php). Si la page d'accueil exige que l'utilisateur soit connecté, mettre sur elle le paquet <span style="font-style:italic;">50 - Proteger une page</span>.</span>
         </div>
        </div>
        ...
        <div id="WEddff655e9d" class="BaseDiv RNone OEWELink OESK_WELink_Default" style="z-index:6">
         <div class="OESZ OESZ_DivContent OESZG_WEddff655e9d">
          <a class="OESZ OESZ_Link OESZG_WEddff655e9d ContentBox OEDynTag0" data-cd="PageLink" href="<?php echo $oei['WEddff655e9d..OEDynTag0.href'];?>">Je n'ai pas encore de compte</a>
         </div>
        </div>
        ...
        <div id="WE8b8e402a10" class="BaseDiv RNone OEWELabel OESK_WELabel_Default" style="z-index:12">
         <div class="OESZ OESZ_DivContent OESZG_WE8b8e402a10">
          <span class="OESZ OESZ_Text OESZG_WE8b8e402a10 ContentBox OEDynTag0" style="<?php echo $oei['WE8b8e402a10..OEDynTag0.style'];?>">Garder ma session ouverte</span>
         </div>
        </div>
       </div>
      </div>
